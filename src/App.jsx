...
export default function App() {
	...
	const btnHamburgerMenu = () => {
		...
		if (header.classList.contains('open-menu')) {
			header.classList.remove('open-menu'); // Close
			mobileMenu.style.transform = 'translateY(-100vh)';
			body.classList.remove('noscroll');
		} else {
			header.classList.add('open-menu'); // Open
				...
				<header>
					<nav className="container-fluid desktop-nav">
						...
						<div className="social-accounts">
							<a href="#" className="acc-link facebook">
								<svg
							...
							<a href="#" className="acc-link instagram">
								<svg
									xmlns="http://www.w3.org/2000/svg"
									width="24"
									height="24"
							...
							<a href="#" className="acc-link tiktok">
								<svg
									xmlns="http://www.w3.org/2000/svg"
									width="24"
									height="24"
							...
							<a href="#" className="acc-link whatsapp">
								<svg
									xmlns="http://www.w3.org/2000/svg"
									width="24"
									height="24"
